...
## Hosting & Domain
The website is live at [siertsebus.github.io/delft-creative-writing-community-website](https://siertsebus.github.io/delft-creative-writing-community-website/). It is hosted on [Github Pages](https://pages.github.com/), which offers free hosting for static websites.

A custom domain can be configured on the GitHub repository. If you have the correct access rights, go to `Repository settings > Pages`. Here you can configure the domain or take the website offline.